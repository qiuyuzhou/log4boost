...
#ifndef JT28092007_time_format_holder_HPP_DEFINED__
#define JT28092007_time_format_holder_HPP_DEFINED__
...
namespace log4boost { namespace formatter{ namespace detail {
		...
		void set_format(const hold_string_type & format) {
			...
			for ( array::iterator begin = indexes.begin(), end = indexes.end(); begin != end; ++begin) {
				...
				*begin->format_idx = idx;
				std::basic_ostringstream<char> cur_sprintf_format;
